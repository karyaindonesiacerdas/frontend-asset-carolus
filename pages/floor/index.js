...
export default function App(props) {
    ...
    const getLoadData = useCallback(() => {
        setIsLoading(true)
        HttpRequestExternal.getFloor().then((res) => {
            setIsLoading(false)
            // // console.log("res", res)
    ...
    const deleteData = useCallback((id) => {
        ...
        HttpRequestExternal.deleteFloor(id).then((response) => {
            refreshData()
            notifyDel()
