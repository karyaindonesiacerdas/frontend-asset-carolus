...
export default function App(props) {
    ...
    const onSubmit = (value) => {
        ...
        HttpRequestExternal.updateAssetBrand(router.query.id, param).then((res) => {
    ...
    const getDetail = useCallback(() => {
        HttpRequestExternal.getAssetBrandDetail(router.query.id).then((res) => {
            setDetail(res.data.data)
            setValue("name", res.data.data.brand_name)
            setValue("desc", res.data.data.brand_desc)
        }).catch((err) => {
