...
export default function App(props) {
    ...
    const deleteData = useCallback((id) => {
        ...
        HttpRequestExternal.deleteLevel(id).then((response) => {
            refreshData()
            notifyDel()
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "Current Safety",
                Footer: "Current Safety",
                accessor: "current_safety",
            },
            {
                Header: "Safety Feature",
                Footer: "Safety Feature",
                accessor: "safety_feature",
            },
            {
                Header: 'Action',
                Footer: 'Action',
