...
export default function App(props) {
    ...
    const getData = useCallback(() => {
        setIsLoading(true)
        HttpRequestExternal.getAssetModel().then((res) => {
            setIsLoading(false)
    ...
    const deleteData = useCallback((id) => {
        ...
        HttpRequestExternal.deleteAssetModel(id).then((response) => {
            refreshData()
            notifyDel()
